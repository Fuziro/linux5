...
def main():
	...
	tiks(W+50*'=')
	print
	tiks(C+'['+W+'1'+C+']'+W+' SPAM CALL V1' +W+'\t100X / 1 HARI'+W+'\tACTIVE'+H+' \xE2\x9C\x94')
	tiks(C+50*'=')
	tiks(C+'['+W+'2'+C+']'+W+' SPAM CALL V2'+W+'\t100X / 1 HARI'+W+'\tACTIVE'+H+' \xE2\x9C\x94')
	tiks(C+50*'=')
	tiks(C+'['+W+'3'+C+']'+W+' SPAM CALL V3'+W+'\t100X / 1 HARI'+W+'\tACTIVE'+H+' \xE2\x9C\x94')
	tiks(C+50*'=')
	...
	try:
		...
		if pilih == '1':
			...
			jumlah = input(''+W+'\tJUMLAH SPAM'+W+' ('+H+' Ex :'+C+' 100 '+W+') : ')
			...
			jumlah = input(''+W+'\tJUMLAH SPAM'+W+' ('+H+' Ex :'+C+' 15 '+W+') : ')
